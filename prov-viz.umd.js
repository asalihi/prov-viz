...
var Graph = (function () {
    ...
    Graph.prototype.removeAgents = function () {
        ...
        this.nodesOfSimplifiedGraph = this.nodesOfSimplifiedGraph.filter(function (n) { return !_.includes(agentsId, n.getId()); });
        this.edgesOfSimplifiedGraph = this.edgesOfSimplifiedGraph.filter(function (e) { return !(_.includes(agentsId, e.getSource()) && !(_.includes(agentsId, e.getTarget()))); });
    };
    /**
...
var GraphFormatterService = (function () {
    ...
    GraphFormatterService.prototype.setNodeColor = function (node) {
        var /** @type {?} */ type = node.getType();
        var /** @type {?} */ subType = node.get('subType');
        var /** @type {?} */ colorProperties = (node.get('color') && _.isObject(node.get('color'))) ? node.get('color') : (COLORS[type] || COLORS[subType] || COLORS['default']);
...
var DagreD3RendererService = (function () {
    ...
    DagreD3RendererService.prototype.setParameters = function (containerElement, data, options) {
        ...
        this.container = d3.select(this.containerElement).append('svg:svg');
